    ...
    methods: {
      ...
      send(){
        ...
        this.$ajax.release({
          ...
          "unitCode": JSON.parse(localStorage.getItem('PaperCode')).code,
          "unitName": JSON.parse(localStorage.getItem('PaperCode')).name,
          "groupAreaDistrictId": this.localStorage.getTeacherInfo.groupAreaDistrictId,
          "groupAreaDistrictName": this.localStorage.getTeacherInfo.groupAreaDistrictName,
        })
