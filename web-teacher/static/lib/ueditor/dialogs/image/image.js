...
//						console.log("图片压缩了吗?" ,editor.getOpt('imageCompressEnable'));
//						console.log(imageCompressBorder,"图片压缩选项");
...
//								url = "http://image.baidu.com/data/imgs?col=" + (key) + "&tag=" + type + "&sort=0&pn=10&rn=10&p=channel&from=1";
