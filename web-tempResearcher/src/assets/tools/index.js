...
export var $user = () => ({
  get: () => localData.get('user344231'),
  set: (user) => localData.set('user344231', user),
...
export let $$user = () => localData.get('user344231') || {};
...
if (baseURL == 'http://diagnosismanager.e-eduspace.com') {
  ...
  rootUrl = 'http://demo.e-eduwisdom.com/';
  rootUrl1 = 'http://demoprotal.e-eduwisdom.com/';
  // rootUrl = 'http://211.157.179.213:8866/';
  // rootUrl1 = 'http://211.157.179.213:8866/';
}
