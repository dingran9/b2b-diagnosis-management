...
export default {
  ...
  getSchoolByStageAndArea(send) {
    return axios.post('groupManager/getSchoolByStageAndArea', send)
  },
  getSubjectByGradeCode(send) {
    return axios.post('teacher/rescours/getSubjectByGradeCode', send)
  },
  getBookTypeVersion(send) {
    return axios.post('teacher/rescours/getBookTypeVersion', send)
  },
  getVolume(send) {
    return axios.post('teacher/rescours/getVolume', send)
  },
  getbookTypeVersionAndUnit(send) {
    return axios.post('teacher/rescours/getbookTypeVersionAndUnit', send)
  },
  getDiagnosisPaperByPaper(send) {
    return axios.post('manager/teacher/getDiagnosisPaperByPaper', send)
  },
  teachingManagerRelease(send) {
    return axios.post('teacher/diagnosis/teachingManagerRelease', send)
  },
  getPaperFullDetail(send) {
    return axios.post('teacher/diagnosis/paperDetail', send)
  }
